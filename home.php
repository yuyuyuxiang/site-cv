...
<section id="about" class="about sec-pad">
    <div class="main-container">
        ...
        <div class="portrait-container">
            <image class="portrait" src="assets/jpeg/portrait.JPG" alt="Portrait Yuxiang ZHANG" data-aos="fade-right"
                   data-aos-offset="100" data-aos-duration="1000"></image>
            <div class="portrait__content">
                <div class="portrait__content-main" data-aos="fade-left" data-aos-offset="100" data-aos-duration="1000">
                    ...
                    <a href="https://drive.google.com/file/d/172khCDq9-H38RlDmQNtMROcnxgQY0hyh/view?usp=sharing"
                       target="_blank" class="btn btn--med btn--theme dynamicBgClr"><?php echo ABOUT_BTN_CV; ?></a>
                </div>
                <script>
...
<section id="projects" class="projects sec-pad">
    <div class="main-container">
        <h2 class="heading heading-sec heading-sec__mb-bg" data-aos="fade-up" data-aos-offset="100"
        ...
        <div class="fly_border" data-aos="zoom-in" data-aos-offset="100" data-aos-duration="500"><i class="top"></i><i
                    class="bottom"></i>
            <div class="box" id="box">
                <div class="inner">
                    ...
                    <ul id="ulimg">
                        <li><a
                                <?php echo 'href="?page=project-detail&projectInitial=auto&lang=' . $lang . '"' ?>
                                    target="view_window"
        ...
        <div class="contact__form-container" data-aos="zoom-in" data-aos-offset="100" data-aos-duration="500">
            <form action="contact.php" method="post" class="contact__form">
                ...
                <button id="btn_submit" name="btn_submit"
                        class="btn btn--theme contact__btn"><?php echo CONTACT_BTN; ?></button>
            </form>
            <div class="contact_info-container">
                ...
                <a href="https://goo.gl/maps/T3Ruh68yBbw3fYBP8" class="contact_address"
                   target="_blank"><?php echo $adress; ?></a>
            </div>
        </div>
    </div>
</section>
...
define("SHORT_INTRO","I am currently studying for a master's degree in CAWEB (Multilingual Web Communication) at the University of Strasbourg. I'm also a full-stack developer");
...
define("ABOUT_SHORT_INTRO","Currently a student in master CAWEB (Multilingual WEB Communication), I'm also working on development of website as a full-stack developer.");
define('ABOUT_TEXT_TITLE', 'Get to know me!');
define('ABOUT_TEXT_1', "Hi, this is <strong>Yuxiang ZHANG</strong>! My studies have helped me a lot to have a deep understanding of computer theory, website development field and master various programming languages (html, CSS, JS, JQuery, etc.). During my studies in the professional license, I worked a lot on the creation of the website using HTML, CSS and JavaScript or using CMSs, for example WordPress. Moreover, the master CAWEB allowed me to improve my knowledge about the website. I also know vue js, one of the three main wireframes required for the front-end. Moreover, thanks to my studies, I know webmarketing, UI/UX webdesign and communication.");
define('ABOUT_TEXT_2', "I am autonomous enough to carry out tasks by myself. At the same time, I am a team player and can therefore adapt well to teamwork. Furthermore, I am curious and interested in the unknown and when I am confronted with something I do not understand, I am willing to learn and ask questions to solve the problems.");
